...
CSRF_TRUSTED_ORIGINS = ['https://breeze.p-e.kr', 'https://like-lion-summerthon-team1.pages.dev']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': ['chat_proj.authorization.CSRFExcemptSessionAuthentication']
}
